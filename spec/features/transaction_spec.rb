...
RSpec.describe 'Transaction page', type: :feature do
  before :each do
    ...
    @user1 = User.new(name: 'Tom', email: 'Tom@gmail.com', password: '123456')
    @user1.save
    @category = Category.new(user: @user1, name: 'Cat 1', icon: attach_file('Image or Icon', 'app/assets/images/user.png',visible: false))
